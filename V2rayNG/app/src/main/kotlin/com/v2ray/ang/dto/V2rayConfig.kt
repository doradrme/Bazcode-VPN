        ...
        data class StreamSettingsBean(var network: String = DEFAULT_NETWORK,
            ...
            fun populateTlsSettings(streamSecurity: String, allowInsecure: Boolean, sni: String) {
                ...
                if (security == TLS) {
                    ...
                    realitySettings = RealitySettingsBean(serverName = sni)
                }
            }

            fun populateRealitySettings(serverName: String, fingerprint: String, publicKey: String, shortId: String, spiderX: String) {
                security = REALITY
